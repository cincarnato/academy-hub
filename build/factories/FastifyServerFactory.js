...
import { ConceptCatalogFastifyRoutes } from "../modules/trainer/routes/ConceptCatalogRoutes.js";
import { FileAssetFastifyRoutes } from "../modules/trainer/routes/FileAssetRoutes.js";
...
function FastifyServerFactory(rootDir) {
    ...
    server.fastifyRegister(ConceptCatalogFastifyRoutes);
    server.fastifyRegister(FileAssetFastifyRoutes);
