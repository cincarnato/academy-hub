...
const ResourceCatalogSchema = new mongoose.Schema<IResourceCatalog>({
...
const ResourceCatalogModel = mongoose.model<IResourceCatalog, PaginateModel<IResourceCatalog>>(MODEL_NAME, ResourceCatalogSchema,COLLECTION_NAME);
